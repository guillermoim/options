...
for k in range(10000):
    ...
    while env.current_state not in env.terminal_states:
        ...
        if leaving_state not in env.terminal_states:
            print('non-terminal', init_state, o, acc_reward_option, leaving_state, np.nanmax(Q[i_ls, :]))
            ...
            Q[i_is, o] = Q[i_is, o] + alpha * (acc_reward_option + np.nanmax(Q[i_ls, :]) - Q[i_is, o])
        elif leaving_state in env.goal_states:
            print('terminal', init_state, o, acc_reward_option, leaving_state, env.r[leaving_state])
            ...
            Q[i_is, o] = Q[i_is, o] + alpha * (acc_reward_option + env.r[leaving_state] - Q[i_is, o])
            break
