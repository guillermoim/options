...
Q_flat = np.loadtxt('results/rooms_Flat_Q_5x5.txt')
...
np.savetxt('results/rooms_H_Q_5x5.txt', Q)
np.save('results/rooms_options_Q_5x5', Qg)
np.savetxt('results/rooms_H_errors_5x5.txt', np.array(errors))
